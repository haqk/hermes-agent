...
| 3b | Strip codebook to simple instruction | ✅ Done | `22fb4ae5` |
| 4 | Hand-compress static content | ✅ Done | `06b27e78` (1,655 chars/turn saved) |
| 5 | Fix Mission Control | ✅ Done | `2688358` (MC) + `2bc52699` (agent) |
| 6 | Activate + verify | ⬜ Ready | — |
